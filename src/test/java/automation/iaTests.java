...
public class iaTests extends BaseTest {
    ...
    public void logintest() {
        ...
        // Esperamos a que se cargue la página antes de hacer clic en "Contratos"
        waitForElementClickable(By.xpath("//article[text()='Gestión']"));

        // Hacemos click en Gestión
        clickElement(By.xpath("//article[text()='Gestión']"), "click en gestion");
    
        // Esperamos a que se cargue la página antes de hacer clic en "Contratos"
        waitForElementClickable(By.xpath("//article[text()='Contratos']"));

        // Hacemos click en Contratos
        clickElement(By.xpath("//article[text()='Contratos']"), "Haciendo click en contratos");

        // Esperamos a que se cargue el botón para crear un nuevo contrato
        waitForElementVisible(By.cssSelector("button svg[data-icon='plus']"));
        ...
        WebElement rutCli = waitForElementVisible(By.cssSelector("input[placeholder='Ingrese su rut']"));
        rutCli.sendKeys("13462900-2");
        Logs.info("escribiendo rut cliente");

        // Esperamos y Click en siguiente tres veces
